...
--
-- Table structure for table `randomqas`
--

DROP TABLE IF EXISTS `randomqas`;
...
--
-- Dumping data for table `randomqas`
--

LOCK TABLES `randomqas` WRITE;
/*!40000 ALTER TABLE `randomqas` DISABLE KEYS */;
INSERT INTO `randomqas` VALUES (0,0,'Technology','null','null',4);
/*!40000 ALTER TABLE `randomqas` ENABLE KEYS */;
UNLOCK TABLES;
